...
renewable_map <- percent_renewable %>% 
  ...
  theme_map() +
  labs(title = "Percent Renewable Energy Mix per State", fill = "Percent", subtitle = "Year: {closest_state}") +
    scale_color_continuous(low = "#edf6b2", high = "#1c5f07")+
  transition_states(Year)

renewable_map <- animate(renewable_map, nframes= 165, end_pause = 20)
